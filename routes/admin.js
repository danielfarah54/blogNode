...
router.post('/categorias/edit', eAdmin, (req, res) => {
    Categoria.findOne({_id: req.body.id}).then((categoria) => {
        ...
        req.flash('error_msg', 'Erro ao editar categoria')
        // console.log(`Erro aqui: ${err}`)Categoria
        res.redirect('/admin/categorias')
    })
})
...
router.get('/postagens', eAdmin, (req, res) => {
    Postagem.find().populate('categoria').sort({date: 'desc'}).then((postagens) => {
        ...
        req.flash('error_msg', 'Erro ao listar as postagens, tente novamente')
        res.redirect('/admin')
    })
})
...
router.get('/postagens/add', eAdmin, (req, res) => {
    Categoria.find().sort({nome: 'asc'}).then((categorias) => {
        res.render('admin/postagem/addpostagens', {categorias: categorias})
    }).catch((err) => {
...
router.get('/postagens/edit/:id', eAdmin, (req, res) => {
    ...
    Postagem.findOne({_id: req.params.id}).then((postagem) => {
        Categoria.find().then((categorias) => {
            res.render('admin/postagem/editpostagens', {
